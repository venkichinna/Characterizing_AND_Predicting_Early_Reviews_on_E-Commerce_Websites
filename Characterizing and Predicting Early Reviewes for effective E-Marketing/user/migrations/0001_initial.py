    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isPurchased', models.CharField(default='pending', max_length=200)),
                ('rating', models.CharField(max_length=200)),
                ('review', models.CharField(max_length=200)),
                ('sentiment', models.CharField(max_length=200)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admins.Prodcuts')),
            ],
        ),
        migrations.CreateModel(
            name='Purchase',
        ...
        migrations.AddField(
            model_name='purchase',
            name='purhased',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admins.Prodcuts'),
        ),
        migrations.AddField(
            model_name='feedback',
            name='user',
